...
- [ ] **Perf gate A:** temporarily raise `toy_count` to 500 (with matching display capacity — add filler capacity if displays don't exist yet), confirm 60 FPS native via overlay, then keep 500 as the new baseline. Log measured FPS.
